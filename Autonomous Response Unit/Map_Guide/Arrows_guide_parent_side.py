...
RIGHT = '/home/omer/Desktop/Autonomous Response Unit/Map_Guide/RIGHT.jpeg'
LEFT = '/home/omer/Desktop/Autonomous Response Unit/Map_Guide/LEFT.jpeg'
Brake = '/home/omer/Desktop/Autonomous Response Unit/Map_Guide/brake.jpeg'
black_window = '/home/omer/Desktop/Autonomous Response Unit/Map_Guide/A_black_image.jpeg'
...
def ShowArrow(photo_path, term):
    ...
    if image is not None:
        ...
        if num_channels == 3 or num_channels == 4:
            ...
            manager.window.wm_geometry("+1650+10")
...
def BrakeGas(photo_path, sec):
    ...
    if image is not None:
        ...
        if num_channels == 3 or num_channels == 4:
            manager = plt.get_current_fig_manager()
            manager.window.wm_geometry("+10+10")  # Adjust window position as needed
...
def Arrows(data):
    ...
    if Map_type == 'Guide_Train':
        ...
        if data.header.seq*0.033333335071821 > 450:
            blackWindow(black_window,30)
...
# Initialize ROS node
rospy.init_node('Arrow_Guide123')
