...
camera_bp.set_attribute('fov', '110.0')             # Decrease FOV to 90 degrees
...
camera_init_trans = carla.Transform(carla.Location(x=0.0, y=0.0, z=1.63), carla.Rotation(pitch=0.0,yaw=0.0))
