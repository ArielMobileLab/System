...
camera_bp.set_attribute('fov', '25.0')
...
camera_init_trans = carla.Transform(carla.Location(x=0.0, y=0.0, z=1.63), carla.Rotation(yaw=180))
camera = world.spawn_actor(camera_bp, camera_init_trans, attach_to=ego_vehicle)

# Start camera with PyGame callback
renderObject = RenderObject(600, 200)  # Set the render object size to match the camera resolution
