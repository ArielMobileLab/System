...
#run_python=python
#"$run_python" "/home/omer/Desktop/Autonomous Response Unit/Senario_Voice/Road_Noice.py" $2 &
#run_python=python3

# Create a new directory with the timestamp
output_directory="/home/omer/Desktop/Parent_experement/Logs_Parent/Close"

# Create the directory if it doesn't exist
mkdir -p "$output_directory"
timestamp=$(date +\%Y-\%m-\%d_\%H-\%M-\%S)
# Define the full path for the video file
output_file="$output_directory/Parent_Close_Physiological_$timestamp.mp4"
