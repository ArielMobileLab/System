...
function cleanup() {
    ...
    pkill -f "$run_python $HOME/Desktop/CARLA_0.9.13/PythonAPI/examples/Map_objects/Train/cars.py"
...
/home/omer/Desktop/CARLA_0.9.13/Carla Logs
...
roslaunch carla_ros_bridge Train.launch town:=$1&
 ...
 "$run_python" "$HOME/cognata_sdk_ros1_ws/src/cognata_sdk/src/N_FaceFunction19.9.py" $2&
 fi
 ...
 "$run_python" "$HOME/Desktop/CARLA_0.9.13/PythonAPI/examples/Map_objects/Train/cars.py" 
