...
roslaunch carla_ros_bridge Coraction.launch town:=$1&
...
#"$run_python" "$HOME/Desktop/CARLA_0.9.13/PythonAPI/examples/Map_objects/Coraction/Corraction_Objects.py" &
...
"$run_python" "$HOME/Desktop/Carla_Logs/Objects_Car_in_lane.py" $2 &


#"$run_python" "$HOME/Desktop/CARLA_0.9.13/PythonAPI/examples/Map_objects/Coraction/Car_Lane.py" &
