...
run_python=python3
"$run_python" "$HOME/Desktop/CARLA_0.9.13/PythonAPI/examples/Map_objects/Parent/Mordechai/Video_Avatar_scenerio2.py" &
run_python=python
...
run_python=python3
"$run_python" "$HOME/Desktop/CARLA_0.9.13/PythonAPI/examples/Map_objects/Parent/Mordechai/photo.py" &
run_python=python
