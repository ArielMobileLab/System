...
run_python=python3
"$run_python" "$HOME/Desktop/Autonomous Resope Unit/Avatar_Parent/Video_Avatar_scenerio1.py" $2 $3 &
run_python=python
...
"$run_python" "$HOME/Desktop/Carla 0.9.13/CARLA_0.9.13/PythonAPI/examples/Map_objects/Parent/Static_A.py" &
"$run_python" "$HOME/Desktop/Carla 0.9.13/CARLA_0.9.13/PythonAPI/examples/Map_objects/Parent/Static_walkers.py" &
"$run_python" "$HOME/Desktop/Carla 0.9.13/CARLA_0.9.13/PythonAPI/examples/Map_objects/Parent/Car_NPC_A.py" &
