...
class ManualControl(CompatibleNode):
    ...
    #    """
        ...
        #array = numpy.reshape(array, (1050, 5760, 4))
...
#creat the publisher that send to the API control commads~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~``
        ...
        self.joy_subscriber = node.new_subscription(
            Joy,
    ...
    def on_joy_input(self, msg):
        """
	The sterring wheel ratio is reference from KIA niro 2019 (https://www.kiamedia.com/us/en/models/niro/2019/specifications) 13.9:1 
	max wheel angel is 450*/13.9* = 32.374*
...
class HUD(object):
	...
	#close the senario:
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#	if  data.header.seq*0.033333335071821 > 5000:
...
def main(args=None):
    ...
    resolution = {"width": 5760, "height": 1050}
    ...
    try:
        ...
        # speedometer_thread = threading.Thread(target=run_speedometer)

    
        # # Start the speedometer thread
