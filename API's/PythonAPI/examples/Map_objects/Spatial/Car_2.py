...
def define_routes(world, spawn_points):
    ...
    routes.append(create_route(world, spawn_points_copy, [1]))
 
   
    # Set car spawn points
    spawn_point_route1 =  spawn_points[242]
...
def Cars(data):
    ...
    if first_car_cross == True and 334.8<data.pose.pose.position.x<334.85:
        print("car_2")
        Generate_Cars()
...
if __name__ == '__main__':
        ...
        rospy.init_node('message_listener3')
