...
def first_walker_cross1():
    ...
    # try:
        ...
        percentagePedestriansCrossing = 1   # Percentage of pedestrians crossing roads
        number_of_walkers = 1
...
def secound_walker_cross2():
    ...
    # try:
        ...
        for i in range(number_of_walkers):
            ...
            #loc = world.get_random_location_from_navigation()
                ...
                Walkerlocation1 = carla.Location(x=342, y=45.2, z=0.300000)
	...
	# For control the trafic lights~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        locp = carla.Location(x=322.096252, y=55.153091, z=0.300000) #person target location 
...
def Cross_Walker(data):
    ...
    if first_walker_cross == True and 190.776831<data.pose.pose.position.x<191.722782898:
       print("walker_1")
       first_walker_cross1()
       first_walker_cross = False

    # if secound_walker_cross == True and 190.776831<data.pose.pose.position.x<191.722782898 :
