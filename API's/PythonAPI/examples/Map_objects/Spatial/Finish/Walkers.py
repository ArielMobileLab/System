...
def Cross_Walker(data):
    ...
    if first_walker_cross_cond == True and 142.0<data.pose.pose.position.x<143.00000:
    
       print("walker_1")
       first_walker_cross()
       first_walker_cross_cond = False

    if secound_walker_cross_cond == True and 180.00000<data.pose.pose.position.x<199.293121338 and -130.0<data.pose.pose.position.y<-128.0 :
        print("walker_2")
