...
def first_walker_cross():
    ...
    spawn_point = carla.Transform(carla.Location(x=162.00, y=50.00, z=0.300000), carla.Rotation(yaw=0.0)) 
    ...
    target_location = carla.Location(x=96.5, y=183.51, z=0.300000) 
    #speed of the walker
...
def Cross_Walker(data):
    ...
    if first_walker_cross_cond == True and 185<data.pose.pose.position.x<232:
