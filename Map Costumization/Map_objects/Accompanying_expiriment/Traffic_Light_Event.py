...
#     if ramzor == True and 185<data.pose.pose.position.x<215: 
...
def ramzor(data):
    ...
    if  ramzor_flag == True and 330.00 < x < 340.00 and -115.00 < y < -90.00 :
        ...
        threading.Timer(4, lambda: traffic_light.set_state(carla.TrafficLightState.Green)).start()
        rospy.loginfo("Traffic light will be set to green in 4 seconds")
        ramzor_flag = False    
