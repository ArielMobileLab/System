...
client.set_timeout(5.0)  # Timeout in seconds
tm = client.get_trafficmanager()
tm_port = tm.get_port()
# Sound of the ambulance
pygame.init()
Ambulance_sound  = pygame.mixer.Sound("/home/omer/Desktop/Autonomous Resope Unit/Arrow_Guide/sound/Ambulance.wav")
...
#    x1_place = carla.Location(x=-513, y=153, z=5.0)
...
#    test = world.spawn_actor(tesla_bp, x1_swap)
#    test.apply_control(carla.VehicleControl(throttle=0.1, steer=0.0, brake=0.0))
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`
 # Define the target coordinates and rotation for the second vehicle (Tesla Model 3)
    x1_place = carla.Location(x=-510.5, y=151, z=5.0)
    x1_rotate = carla.Rotation(pitch=-1.156556, yaw=90.0, roll=0.0)
    x1_swap = carla.Transform(x1_place, x1_rotate)
    ...
    x1.apply_control(carla.VehicleControl(throttle=0.1, steer=0.0, brake=1.0))
    vehicles.append(x1)

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`
 # Define the target coordinates and rotation for the second vehicle (Tesla Model 3)
    x2_place = carla.Location(x=-510.5, y=160, z=5.0)
    ...
    x2.apply_control(carla.VehicleControl(throttle=0.1, steer=0.0, brake=1.0))
    vehicles.append(x2)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`
    ...
    for i in range(30):
        if i == 0:
            ...
            tm.set_global_distance_to_leading_vehicle(50.0) 
            vehicles.append(ambulance)
            time.sleep(1)
        if i == 4:  
            pygame.mixer.Sound.play(Ambulance_sound) 
        if i == 6: 
            pygame.mixer.Sound.play(Ambulance_sound) 
        if i == 8: 
            pygame.mixer.Sound.play(Ambulance_sound)      
